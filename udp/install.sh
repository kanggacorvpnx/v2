...
DB_URL="https://raw.githubusercontent.com/kanggacorvpnx/permission/main/regist"
...
# CONFIG
wget -qO /etc/zivpn/config.json https://raw.githubusercontent.com/kanggacorvpnx/v2/main/udp/config.json
